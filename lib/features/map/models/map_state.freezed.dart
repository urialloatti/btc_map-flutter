...
abstract class $MapStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Set<Marker> markers, bool isLoading});
}
...
class _$MapStateImpl implements _MapState {
  const _$MapStateImpl(
      {final Set<Marker> markers = const {}, this.isLoading = false})
      : _markers = markers;
  ...
  @override
  String toString() {
    return 'MapState(markers: $markers, isLoading: $isLoading)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_markers), isLoading);
...
abstract class _MapState implements MapState {
  const factory _MapState({final Set<Marker> markers, final bool isLoading}) =
      _$MapStateImpl;
